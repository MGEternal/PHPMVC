            ...
            <div class="col-xs-10">
              ...
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <strong>แสดงกลุ่มการเรียนทั้งหมด</strong>
                </div>
                <div class="card-body">
                  ...
                  <table id="demo-datatables-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                    ...
                    <?php foreach($result as $res){ ?>
                          <tr>
                            ...
                            <td>
                            <a type ='button'   onclick="javascript:window.location='<?php echo base_url() . 'admin/edit_class/' . $res->cls_id; ?>';"><label class='btn btn-warning'>แก้ไข</label></a> &nbsp 
        ...
        <div class="modal-content">
          <div class="modal-body ">
            <div class="text-center">
              ...
              <div class="m-t-lg">
              <?php echo "<a type='button' href='".base_url()."admin/delete_class/".$res->cls_id."' ' ><label class='btn btn-danger'>ยืนยัน</label></a>";?>
