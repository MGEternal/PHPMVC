            ...
            <?php echo $this->session->flashdata("success_del"); ?>
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <strong>อนุมัติสถานประกอบการเข้าสู่ระบบ</strong>
                </div>
                  ...
                  <table id="demo-datatables-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                    ...
                    <?php foreach($result as $res){ ?>
                          <tr>
                            ...
                            <td>
                            <a type ='button'   onclick="javascript:window.location='<?php echo base_url() . 'bilateral/index3/' . $res->cpn_id; ?>';"><label class='btn btn-success'>ดูข้อมูลเพิ่มเติม</label></a> 
