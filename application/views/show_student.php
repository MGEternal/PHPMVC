            ...
            <div class="col-xs-10">
              ...
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <strong>แสดงนักเรียนทั้งหมดในระบบ</strong>
                </div>
                <div class="card-body">
                  ...
                  <table id="demo-datatables-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                    ...
                    <?php foreach($result as $res){ ?>
                          <tr>
                            ...
                            <td>
                            <a type ='button'   onclick="javascript:window.location='<?php echo base_url() . 'admin/edit_student/' . $res->std_id; ?>';"><label class='btn btn-warning'>แก้ไข</label></a> &nbsp 
