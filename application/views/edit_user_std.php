                ...
                <div class="col-md-8">
                    <div class="demo-form-wrapper">
                        ...
                        <input id="form-control-1" name="std_id" class="form-control" type="hidden" value="<?php echo $result[0]->std_id ?>" hidden>
                            ...
                            <div class="form-group">
                            <label class="col-sm-1 control-label" for="form-control-1">USER GROUP</label>
                                <div class="col-sm-3 col-sm-offset-0">
                                    <select name="user_group" class="custom-select">
                                        <!-- <option value="" selected="">--Default--</option> -->
                                        <option value="student" <?php if($result[0]->user_group == 'student'){echo "selected";} ?>>student</option>
                                        <option value="teacher" <?php if($result[0]->user_group == 'teacher'){echo "selected";} ?>>teacher</option>
                                        <option value="company" <?php if($result[0]->user_group == 'company'){echo "selected";} ?>>company</option>
                                        <option value="admin" <?php if($result[0]->user_group == 'admin'){echo "selected";} ?>>admin</option>
                                    </select>
                                </div>
                            </div>
